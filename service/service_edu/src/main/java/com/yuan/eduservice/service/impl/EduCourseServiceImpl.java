...
import com.yuan.eduservice.entity.EduCourseDescription;
import com.yuan.eduservice.entity.frontvo.CourseFrontVo;
...
import com.yuan.eduservice.mapper.EduCourseMapper;
import com.yuan.eduservice.service.EduChapterService;
import com.yuan.eduservice.service.EduCourseDescriptionService;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    public String saveCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(insert == 0) {
            //添加失败
            throw new YuanException(20001,"添加课程信息失败");
        }
    ...
    public void updateCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(update == 0) {
            throw new YuanException(20001,"修改课程信息失败");
        }
    ...
    public void removeCourse(String courseId) {
        ...
        if(result == 0) { //失败返回
            throw new YuanException(20001,"删除失败");
        }
    }
